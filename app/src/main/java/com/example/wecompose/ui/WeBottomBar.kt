...
@Composable
fun WeBottomBar(selected: Int, onSelectionChanged: (Int) -> Unit) {
...
@Composable
fun TabItemPreview() {
    TabItem(iconId = R.drawable.ic_chat_outlined, title = "聊天", WeComposeTheme.colors.icon)
}
...
@Preview(showBackground = true)
@Composable
fun WeBottomBarPreviewLightNewYear() {
